...
class DashboardController extends AbstractActionController
{
   ...
   public function ajaxGetStateListAction()
   {
       try {
                      $sm = $this->getServiceLocator();
		      $identity = $sm->get('AuthService')->getIdentity();
                      ...
                      $params = $this->getRequest()->getQuery()->toArray();
                      $objUserTable = $sm->get('Leave\Model\LeaveTable');
                      $leadsArr = $objUserTable->fetchStateList($params);
   ...
   public function ajaxGetProductsListAction()
   {
       try {
                      $sm = $this->getServiceLocator();
		      $identity = $sm->get('AuthService')->getIdentity();
                      ...
                      $params = $this->getRequest()->getQuery()->toArray();
                      $objUserTable = $sm->get('Leave\Model\LeaveTable');
                      $leadsArr = $objUserTable->fetchProductList($params);
      ...
      public function ajaxGetHowHeardListAction()
   {
       try {
                      $sm = $this->getServiceLocator();
		      $identity = $sm->get('AuthService')->getIdentity();
                      ...
                      $params = $this->getRequest()->getQuery()->toArray();
                      $objUserTable = $sm->get('Leave\Model\LeaveTable');
                      $leadsArr = $objUserTable->fetchHowHeardList($params);
