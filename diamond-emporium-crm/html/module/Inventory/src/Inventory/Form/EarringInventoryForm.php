...
class EarringInventoryForm extends Form {
	...
	public function __construct($objServiceManager) {
		try{
			...
			$dimensions = new \Zend\Form\Element\Text('dimensions');
			$dimensions->setLabel('Dimensions');
			$dimensions->setAttributes(array('id' => 'dimensions', 'class' => 'inputTxt', 'maxlength' => 20));
			$this->add($dimensions);
