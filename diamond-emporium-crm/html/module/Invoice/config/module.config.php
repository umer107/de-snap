...
use Invoice\Form\ComposeEmailForm;
use Invoice\Form\ReplyEmailForm;
...
return array(
			...
			'invoice' => array(
				...
				'child_routes' => array(
                   ...
                   'ajax-invoice' => array(
					...
					'composeinvoiceemail' => array(
						'type' => 'Segment',
						'options' => array(
							'route' => 'composeinvoiceemail',
							'defaults' => array(
								'controller' => 'Invoice\Controller\Index',
								'action' => 'composeinvoiceemail',
							),
						),
					),
					'ajaxgetinvoiceemail' => array(
						'type' => 'Segment',
						'options' => array(
							'route' => 'ajaxgetinvoiceemail',
							'defaults' => array(
								'controller' => 'Invoice\Controller\Index',
								'action' => 'ajaxgetinvoiceemail',
							),
						),
					),
					'viewinvoiceemail' => array(
						'type' => 'Segment',
						'options' => array(
							'route' => 'viewinvoiceemail/:id',
							'defaults' => array(
								'controller' => 'Invoice\Controller\Index',
								'action' => 'viewinvoiceemail',
							),
						),
					),
					'replyemail' => array(
					...
					'editinvoicequotes' => array(
						'type' => 'Segment',
						'options' => array(
							'route' => 'editinvoicequotes[/:id]',
							'defaults' => array(
								'controller' => 'Invoice\Controller\Index',
								'action' => 'editinvoicequotes',
							),
						),
					),
				),
	...
	'service_manager' => array(
		...
		'factories' => array(
			...
			'Invoice\Form\ComposeEmailForm' => function() {
				return new ComposeEmailForm();
			},
			'Invoice\Form\ReplyEmailForm' => function() {
				return new ReplyEmailForm();
			},
		),
	),
	'translator' => array(
