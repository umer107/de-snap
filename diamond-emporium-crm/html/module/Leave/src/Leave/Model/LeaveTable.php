            ...
            try {
                 ...
                 $fullname = new \Zend\Db\Sql\Expression(
                  ...
                  $select->from(array('l' => 'de_leads'))
                        ->columns(array('Lead_id' => 'lead_id','LeadCustomerId' =>'customer_id','LeadTitle' =>'title','LeadGender' =>'gender' ,'LeadFirst_name' =>'first_name', 'LeadLast_name' => 'last_name' , 'LeadEmail' => 'email' , 'LeadMobile' => 'mobile','LeadState_id' => 'state_id','LeadSource' =>  'lead_source','LeadOwnerId' => 'lead_owner','LeadLookingFor' =>  'looking_for','LeadReference' => 'reference_product','LeadReferredbyCustomer' => 'referred_by_customer', 'LeadPreferredContact_method' => 'preferred_contact' ,'LeadStatus' => 'lead_status','LeadCreatedDate' => 'created_date','LeadBudget' => 'budget'))
     ...
     public function  fetchCheckLeadEmail($filter= null)
     {
       ...
       public function fetchLeadRecord($filter= null)
       {
               $fullname = new \Zend\Db\Sql\Expression(
                ...
                $fullnameUsers = new \Zend\Db\Sql\Expression(
                    'CONCAT(u.first_name, \' \', u.last_name)'
               );    
                ...
                $select->from(array('l' => 'de_leads'))
                        ...
                        ->join(array('u' => 'de_users'), 'l.lead_owner = u.user_id', array('LeadOwnerName' => $fullnameUsers), 'left')   
 ...
 public function fetchNextInLineUser($filter = null)     
      ...
      public function  fetchCustomerNameData()
   {
		...
		$other_leadId = 90000;
                ...
                $select = new \Zend\Db\Sql\Select(); 
                $select->from(array('l' => 'de_leads')) ->columns(array('Lead_id' => 'lead_id','LeadCustomerId' =>'customer_id','LeadTitle' =>'title','LeadGender' =>'gender' ,'LeadFirst_name' =>'first_name', 'LeadLast_name' => 'last_name' , 'LeadEmail' => 'email' , 'LeadMobile' => 'mobile','LeadState_id' => 'state_id','LeadSource' =>  'lead_source','LeadOwnerId' => 'lead_owner','LeadLookingFor' =>  'looking_for','LeadReference' => 'reference_product','LeadReferredbyCustomer' => 'referred_by_customer', 'LeadPreferredContact_method' => 'preferred_contact' ,'LeadStatus' => 'lead_status', 'LeadBudget' => 'budget', 'LeadSpecialInstruction' => 'special_instructions'))
    ...
    if($budget == '$2,000 - $4,999') 
     { 
       ...
       $select_detail->from(array('l' => 'de_leads')) 
           ->columns(array( 
              'Lead_id' => 'lead_id','LeadCustomerId' =>'customer_id','LeadTitle' =>'title','LeadGender' =>'gender' ,'LeadFirst_name' =>'first_name', 'LeadLast_name' => 'last_name' , 'LeadEmail' => 'email' , 'LeadMobile' => 'mobile','LeadState_id' => 'state_id','LeadSource' =>  'lead_source','user_id' => 'lead_owner','LeadLookingFor' =>  'looking_for','LeadReference' => 'reference_product','LeadReferredbyCustomer' => 'referred_by_customer', 'LeadPreferredContact_method' => 'preferred_contact' ,'LeadStatus' => 'lead_status'  ,'lead_assign_to' => 'lead_owner' , 'LeadBudget' => 'budget'
