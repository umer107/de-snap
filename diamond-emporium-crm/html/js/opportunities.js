function getOpportunities(recordsPerPage, keyword, searchParams){
	...
	$("#jqxOpportunities").jqxGrid(
	{
		...
		columns: [
			{ text: 'Created', type: 'string', datafield: 'created_date', width:'6%' },
			{ text: 'Status', type: 'string', datafield: 'opportunity_status', width:'6%' },
			{ text: 'Order', type: 'string', datafield: 'order_id', width:'6%' },
			{ text: 'Customer<br /> Owner', type: 'string', datafield: 'customer_fullname', width:'6%' },
			{ text: 'Email', type: 'string', datafield: 'customer_email', width:'10%' },
			{ text: 'Opportunity Name', type: 'string', datafield: 'opportunity_name', width:'6%' },
			{ text: 'Mobile <br />	Number', type: 'string', datafield: 'customer_mobile', width:'6%' },
			{ text: 'Rating', type: 'string', datafield: 'rating', width:'6%' },
			{ text: 'Est. <br/> Revenue', type: 'string', datafield: 'budget', width:'6%' },
			{ text: 'Predicted Close Date', type: 'string', datafield: 'est_close_date', width:'6%' },
			{ text: 'Notes', type: 'string', datafield: 'note_description', width:'6%' },
			{ text: 'Edit <br /> Notes', type: 'string', datafield: 'note_id', cellsrenderer: cellsrenderer, width:'6%' },
			{ text: 'Follow up <br /> Date', type: 'string', datafield: 'preferred_contact', width:'6%' },
			{ text: 'Account <br /> Owner', type: 'string', datafield: 'account_owner', width:'6%' },
		]
...
function getOpportunitiesFromGridView(recordsPerPage, columnList, keyword, searchParams){
	...
	var colList = columnList.split(',');
		...
		if(colList.length>6){
			...
			if(colList[i] == 'note_description'){
				gridColumnList.push({ text: 'Notes', type: 'string', datafield: 'note_description', width:'6%'});
			}
