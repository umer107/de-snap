...
/// Common light box click function/////
    $('body').on('click', '.lightBoxClick', function () {
        ...
        $("#" + $(this).attr('data-popup')).show().addClass('newUI').addClass('showAnimation');
		if($("#" + $(this).attr('data-popup')).find('.lightBoxBottom').length==0){
			$("#" + $(this).attr('data-popup')).append('<div class="lightBoxBottom"></div>');
		}
        ...
        $.post(url, data, function (response) {
            ...
            if (response != 0) {
                ...
                if (gridType == 'leads') {
                    ...
                    getOpportunitiesFromGridView(recordsPerPage, serverResult[2], keyword);
                    ...
                    getJobPacketsFromGridView(recordsPerPage, serverResult[2], keyword);
                }
            }
            ...
            $.post(url, data, function (response) {
                if (response == 1) {
                    ...
                    if (gridType == 'leads') {
                        ...
                        getOpportunities(recordsPerPage, keyword);
                    } else if (gridType == 'suppliers') {
        ...
        if (gridType == 'leads') {
            ...
            if (selectedValue != '') {
                ...
                $.post(url, data, function (response) {
                    var setting = JSON.parse(response);
                    var columnList = setting.columns_list;
                    getOpportunitiesFromGridView(recordsPerPage, columnList, keyword, formData);
                });
            } else {
    ...
    if (gridType == 'leads') {
        ...
        if (selectedValue != '') {
            ...
            $.post(url, data, function (response) {
                var setting = JSON.parse(response);
                var columnList = setting.columns_list;
                getOpportunitiesFromGridView(recordsPerPage, columnList, keyword);
            });
        } else {
			var formData = $('#frm_filter_fpportunity').serialize();
