...
class OrderForm extends Form {
	...
	public function __construct() {
		try{
			...
			$this->setAttributes(array('name' => 'frm_order', 'id' => 'frm_order', 'action' => '/uploadfile', 'enctype' => 'multipart/form-data', 'method' => 'post'));
			...
			$order_attachment = new \Zend\Form\Element\Hidden('order_attachment');
			$order_attachment->setAttributes(array('id' => 'order_attachment'));
			...
			$order_file->setAttributes(array('id' => 'order_file'));
			$this->add($order_file);
