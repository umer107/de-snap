...
use Opportunities\Model\NotesTable;
...
return array(
    ...
    'service_manager' => array(
        ...
        'factories'=>array(
			...
			'Opportunities\Model\NotesTable' =>  function($sm) {
        		$dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
				$resultSetPrototype = new HydratingResultSet();
				$config = $sm->get('Config');        
			...
			'Opportunities\Form\OpportunitiesForm' => function($sm) {				
				return new OpportunitiesForm($sm->get('Customer\Model\ProductsTable'), $sm->get('Customer\Model\StatesTable'), $sm->get('Customer\Model\LeadTypesTable'));
			},
		),
    ),
    'translator' => array(
