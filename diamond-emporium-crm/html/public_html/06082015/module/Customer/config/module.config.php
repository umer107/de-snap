...
use Customer\Model\LeadTypesTable;
...
return array(
    ...
    'service_manager' => array(
        ...
        'factories'=>array(
			...
			'Customer\Model\LeadTypesTable' =>  function($sm) {
        		$dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
				$resultSetPrototype = new HydratingResultSet();
				$config = $sm->get('Config');        
				$tableGateway = new TableGateway($config["dbPrefix"].'lead_types', $dbAdapter, null, $resultSetPrototype);
				$table = new LeadTypesTable($tableGateway);
				return $table;
			},
